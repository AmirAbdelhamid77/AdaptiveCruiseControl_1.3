...
#endif
// ... other SR flags if needed (PE, ORE, etc.)
...
// Clock reset macros
#define RCC_USART1_Reset()         RCC_USART1_CLK_Reset()
#define RCC_USART2_Reset()         RCC_USART2_CLK_Reset()
#define RCC_USART3_Reset()         RCC_USART3_CLK_Reset()

// NVIC USART IRQ Enable/Disable
