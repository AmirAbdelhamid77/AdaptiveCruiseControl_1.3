...
#define I2C_OAR2_ENDUAL                 (1 << 0)    // Dual Address Mode
#define I2C_OAR2_ADD2_Pos               1           // Interface Address 2

// Clock reset macros
#define RCC_I2C1_CLK_RESET()            RCC_I2C1_CLK_Reset()
#define RCC_I2C2_CLK_RESET()            RCC_I2C2_CLK_Reset()

// NVIC I2C IRQ Enable/Disable
